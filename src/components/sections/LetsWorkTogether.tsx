  ...
  return (
    <div className="w-full h-fit flex flex-col items-start justify-center gap-4 py-2">
      ...
      <div className="w-full px-2 sm:px-4 md:px-10">
        <div 
          className="w-full relative aspect-video sm:aspect-[2/1] overflow-hidden group rounded-xl shadow-xl mx-auto"
        >
          <img 
          ...
          />
          <div className="absolute inset-0 flex flex-col items-center justify-center p-6 sm:p-10 bg-black/20">
            <div className="h-16 sm:h-20 md:h-24 w-full relative flex justify-center items-center mb-4 perspective-[1000px]">
