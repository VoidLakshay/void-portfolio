...
const Options = ({
  ...
  return (
    <motion.div
      drag
      className="top-30 border-foreground/10 bg-muted absolute right-1/2 flex w-[245px] translate-x-1/2 flex-col gap-3 rounded-3xl border p-3 backdrop-blur-sm lg:right-4 lg:translate-x-0"
    >
        ...
        {variant === "gif" && gifType === "custom" && (
          <div className="mt-1 flex flex-col gap-1 py-1">
            ...
            <input
              ...
              className="text-foreground placeholder:text-foreground/50 w-full rounded-lg border border-white/20 bg-transparent px-2 py-1 text-xs focus:outline-none"
            />
          </div>
        )}
      </div>
...
export const ThemeToggleButton = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "size-10 cursor-pointer rounded-full bg-black border border-white/20 p-0 transition-all duration-300 active:scale-95 flex items-center justify-center",
        className,
      )}
      onClick={toggleTheme}
    ...
    >
      ...
      <svg viewBox="0 0 240 240" fill="none" className="w-5 h-5" xmlns="http://www.w3.org/2000/svg">
        <motion.g
